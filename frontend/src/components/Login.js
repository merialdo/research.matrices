...
export default class Login extends Component{
  ...
  render(){
    ...
    return (
        <section className="auth-section signup-section text-center py-5" style={{backgroundColor: "rgba(0,0,0,0.02)"}}>
            <div className="container">
                ...
                <div className="LoginForm">
                    <form>
                        ...
                        <Button onClick={this.handleRegistration}  className="btn btn-primary btn-lg center btn-register"> Register</Button>
                    </form>
                    <div className="auth-option text-center pt-5 already_account">
            Already have an account? <button type="button" className="btn btn-link" onClick={this.goToRegister}>Log in</button>
        </div>
      ...
      <div className="container">
          ...
          <div className="LoginForm">
              <form>
                  ...
                  <Button onClick={this.handleSignIn}  className="btn btn-primary btn-lg center btn-register" style={{marginBottom:"15px"}}> Log-In with Us</Button>
              </form>
              {/* <div className="social-auth text-center mx-auto">
            <ul className="social-buttons list-unstyled">
              <li className="mb-3">
        ...
        <div className="auth-option text-center pt-5 already_account">
            Don't have an account yet? <button type="button" className="btn btn-link" onClick={this.goToRegister}>Create a new one</button>
        </div>
</div>
</div>
</div>
